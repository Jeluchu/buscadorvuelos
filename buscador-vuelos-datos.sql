...
INSERT INTO TERMINAL VALUES ('S1','QSA');
...
INSERT INTO VUELO VALUES ('I0QSVTE','RTG','AEROPUERTO DE TENERIFE NORTE', 'TFN','E1', 'AEROPUERTO ADOLFO SUÁREZ MADRID-BARAJAS', 'MAD', 'T2', 'Delayed');
INSERT INTO VUELO VALUES ('D7BRC1S','EWS','AEROPUERTO DEL FARO', 'FAO','Y3', 'AEROPUERTO DE ALICANTE-ELCHE', 'ALC', 'B2', 'Delayed');
...
INSERT INTO PASAJERO VALUES ('47696918H','JOSÉ LUIS','LÓPEZ', 'BRIONES', 'SI');
...
INSERT INTO EQUIPAJE VALUES ('39831977W','55','6','CABINA');
INSERT INTO EQUIPAJE VALUES ('73698918H','170','20','BODEGA');
INSERT INTO EQUIPAJE VALUES ('03842052V','60','10','CABINA');
INSERT INTO EQUIPAJE VALUES ('60985429D','147','24','BODEGA');
INSERT INTO EQUIPAJE VALUES ('54358219L','180','20','BODEGA');
INSERT INTO EQUIPAJE VALUES ('47696918H','60','8','CABINA');
INSERT INTO EQUIPAJE VALUES ('79872060Y','170','22','BODEGA');
...
INSERT INTO RESERVA VALUES ('D7BRC1S', '79872060Y', '98');
...
/* ACTUALIZACIÓN DEL ESTADO DEL AVIÓN */
UPDATE VUELO SET Estado = 'Delayed' WHERE  CodVuelo = 'DQGYPVY';
UPDATE VUELO SET Estado = 'Advance' WHERE  CodVuelo = 'VNAD2MO';
UPDATE VUELO SET Estado = 'Advance' WHERE  CodVuelo = 'R09PLBY';
UPDATE VUELO SET Estado = 'OnTime' WHERE  CodVuelo = 'I0QSVTE';
UPDATE VUELO SET Estado = 'OnTime' WHERE  CodVuelo = 'D7BRC1S';

/* ELIMINACIÓN DE DATOS */ 
DELETE FROM PASAJERO WHERE DNI = '03842052V';
DELETE FROM RESERVA WHERE DNI = '03842052V';
DELETE FROM EQUIPAJE WHERE CodMaleta = '03842052V';
